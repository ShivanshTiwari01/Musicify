    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-[#888888] mt-1">Start your musical journey</p>
        </div>
        ...
        <div className="bg-[#111111] border border-[#2a2a2a] rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              <label className="block text-sm font-medium text-[#888888] mb-1.5">Name</label>
              <input
                type="text"
                value={name}
          ...
          <p className="text-center text-sm text-[#888888] mt-6">
            ...
            <Link to="/login" className="text-[#e5173f] hover:text-[#ff1f4a] font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
